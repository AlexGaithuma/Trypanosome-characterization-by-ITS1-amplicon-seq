...
# Full Data Access
The full set of raw data is available in NCBI repository; Sequence Read Archive (SRA) under the SRA accession: SRP159480.
The amplicon sequence variants (ASVs) or clustered representative sequences are available under GenBank submission: SUB4757113 with accession numbers MK131764 - MK132190
